...
def main_function():
	...
	data = "/gpfs/group/home/thanigan/thanigan/Sequencing/Resistant_Clones/fc-c662c8e5-11d4-4fbd-a5b3-6fa758fb5ee4/Scripps_Hanigan_WGS_DataDelivery_12samples/RP-2289/WGS/Mutect_Combined_BC/Sig_Profiler_022121_5FU/" # you can put the path to your folder containing the vcf !!!NOte the vcf must be in its own folder seperate from the folder that you are working in/that output will be put in.
...
def main_function():
	...
	data2 = "/gpfs/group/home/thanigan/thanigan/Sequencing/Resistant_Clones/fc-c662c8e5-11d4-4fbd-a5b3-6fa758fb5ee4/Scripps_Hanigan_WGS_DataDelivery_12samples/RP-2289/WGS/Mutect_Combined_BC/Sig_Profiler_022221_5FU_Out/" # you can put the path to your tab delimited file containing the mutational catalog matrix/table
